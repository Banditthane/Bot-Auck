...
for (const file of files) {
    ...
    try {
      ...
      results.commands.push({ name, status: "OK" })

    } catch (err) {

      results.commands.push({ name, status: "ERROR" })
      results.errors++
...
for (const file of files) {
    ...
    try {
      ...
      results.events.push({ name, status: "OK" })

    } catch (err) {

      results.events.push({ name, status: "ERROR" })
      results.errors++
...
for (const file of files) {
    ...
    try {
      ...
      results.services.push({ name, status: "OK" })

    } catch (err) {

      results.services.push({ name, status: "ERROR" })
      results.errors++
...
for (const file of files) {
    ...
    try {
      ...
      results.repositories.push({ name, status: "OK" })

    } catch {

      results.repositories.push({ name, status: "ERROR" })
      results.errors++
